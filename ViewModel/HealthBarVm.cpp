...
HealthBarVm::HealthBarVm(const Dx::IResourceController& i_resourceController, const HealthBar& i_healthBar)
...
void HealthBarVm::reloadResources(const Dx::IResourceController& i_resourceController)
{
...
void HealthBarVm::render(Dx::IRenderer& i_renderer) const
{
